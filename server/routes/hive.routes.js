...
module.exports = (app) => {
    ...
    // Route for fetching weather for a specific inspection tied to a specific hive
    app.get('/api/hives/:hiveId/inspections/:inspectionId/weather', InspectionController.fetchWeatherData);
};
